...
def c3d_ucf101_finetune(inputs, training, weights=None):
    ...
    net = tf.layers.max_pooling3d(inputs=net, pool_size=2, strides=2, padding='SAME',name="maxpolling2")
    net = tf.layers.conv3d(inputs=net, filters=256, kernel_size=3, padding='SAME', activation=tf.nn.relu,
    ...
    net = tf.layers.max_pooling3d(inputs=net, pool_size=2, strides=2, padding='SAME',name="maxpooling3")
    net = tf.layers.conv3d(inputs=net, filters=512, kernel_size=3, padding='SAME', activation=tf.nn.relu,
    ...
    net = tf.layers.max_pooling3d(inputs=net, pool_size=2, strides=2, padding='SAME',name="maxpooling4")
